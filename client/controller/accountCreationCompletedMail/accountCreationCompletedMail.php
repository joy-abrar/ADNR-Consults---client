<?php
        ...
        try {
            ...
            */
            ...
            $mail->Body    = "Félicitations " . $firstname . ",<br> <em>Votre compte à bien été crée avec succès.</em><br> Votre Identifiant est suivant:" . $username . "<br><span style='color:green'>Pour bien vous connecter, veuillez utiliser cet identifiant et le mot de passe que vous avez choisi lors de la création de votre compte.<br><br>ADNR Consults vous souhaite une excellente journée.";
