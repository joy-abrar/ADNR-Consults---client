     ...
     dashboardAppearenceStatus = getvalue;
   	...
   	switch(dashboardAppearenceStatus)
   	{
   		case 'dashboard' :
            ...
            document.getElementById('secondBloc').style="visibility:visible";
        ...
        document.getElementById('secondBloc').style="visibility:hidden";
        ...
        /*
        document.getElementById('secondBloc').style="visibility:hidden";
        document.getElementById('secondSubBlocOne').style="visibility:hidden";
        document.getElementById('secondSubBlocTwo').style="visibility:hidden";
        document.getElementById('secondSubBlocThree').style="visibility:hidden";
        document.getElementById('secondSubBlocFour').style="visibility:hidden";
        */
